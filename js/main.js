...
function list_html() {
  ...
  todos.forEach((element, index) => {
    text_do.innerHTML += `
            <div id="Delete_block${index}" class="text-child alert alert-secondary d-flex justify-content-between" ondblclick="text_child(this)">
            ...
            <p class="time-child m-2 opacity-50">
                ...
                <img onclick="deleteActive(${index})" src="img/delete.svg" 
class="delete-icon"alt="">
                </div>
                </div>
                `;
  });
